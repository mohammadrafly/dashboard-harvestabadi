...
const AddArticle = () => {
    ...
    return (
        <div className={`min-h-screen p-4 md:p-8 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
            <h1 className="text-3xl font-semibold mb-6">Add New Article</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
                <div>
                    ...
                    <input
                        ...
                        required
                        placeholder="Enter article title" // Placeholder added here
                ...
                <div>
                    ...
                    <input
                        ...
                        value={slug}
                        readOnly
                        placeholder="Generated slug will appear here" // Placeholder added here
